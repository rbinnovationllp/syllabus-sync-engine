...
import { Brain, LogOut, CreditCard, Shield, Users, Briefcase, Building2, ClipboardCheck, Landmark, BrainCircuit, LightbulbIcon } from "lucide-react";
      ...
      <header className="border-b sticky top-0 z-10 bg-background/95 backdrop-blur">
        <div className="mx-auto flex h-14 w-full max-w-screen-2xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button asChild variant="ghost" size="sm">
              <Link to={"/v2/copilot" as any}>
                <LightbulbIcon className="h-4 w-4 mr-1" /> Teaching AI
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm">
