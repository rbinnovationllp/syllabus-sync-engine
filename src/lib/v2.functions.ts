...
function offlineDraft(data: z.infer<typeof draftInput>, ctx: any) {
  ...
  const byModule: Record<string, string[]> = {
    ...
    content_studio: [
      heading,
      "Editable teaching resource draft",
      `Topic/request: ${data.prompt}`,
      "",
      "Book, chapter-list, and syllabus mapping:",
      "1. Confirm board, book name, publisher, chapter list, topic, learning objectives, and expected class level before classroom use.",
      "2. Align the resource with the planned syllabus portion and today's teaching schedule.",
      "3. Use official/open resources where legally available. For private publisher books, use only school-provided chapter details or permitted extracts.",
      "",
      "Teacher explanation:",
      "Provide a simple explanation, one board example, and one misconception to watch for.",
      "",
      "Activity-based learning:",
      "Add one low-cost classroom activity, one pair/group task, and one real-life example connected to the local environment.",
      "",
      "Practice and assessment:",
      "Section A: Key concepts and definitions.",
      "Section B: Practice tasks from simple to challenging.",
      "Section C: Application or higher-order questions.",
      "Section D: Exit ticket or quick oral check.",
      "",
      "Interactive classroom template:",
      "Use one suitable format: matching activity, diagram labeling, concept map, timeline, sorting table, observation diary, role-play card, or mini-project checklist.",
      "",
      "Answer key and teacher review:",
      "Add or revise answers before export. Teacher must review for chapter-list alignment, age suitability, local context, copyright permissions, and school policy.",
    ],
    assessment_generator: [
      heading,
