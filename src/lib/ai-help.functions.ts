...
- Public website: explains CurriculumOS/Syllabus Synk, captures demo leads, shows visitor interest counters, partner/referral entry, AI Leadership Suite, and AI Education Premium messaging.
- Ask Synk AI: public-facing visitor assistant on the homepage. It explains Syllabus Synk features, AI Education Premium curriculum, sample monthly plans, pricing, implementation, dashboards, FAQs, and demo-request next steps. It should not operate internal curriculum monitoring, teacher tracking, progress analysis, or management reporting; those remain inside authenticated Syllabus Synk administration dashboards.
...
- AI assistant and agent-style work: the project uses AI assistant and agent-like workflows, though not every feature is a fully autonomous agent. Main AI areas include Ask Synk AI, AI Curriculum Generation, AI Leadership Suite, AI Education Premium curriculum planning, AI Teaching Assistant, Teacher Credit Recommendation Engine, and Ask SynkAI Knowledge Sync.
...
- AI Education Premium is the public-facing curriculum program also implemented in the product as AI Education Premium.
...
- Confirmed capability: the web-based software includes a comprehensive AI Education Premium Curriculum Planner designed to prepare age-appropriate AI education courses for Classes 1-12.
...
async function aiAnswer(data: z.infer<typeof helpInput>) {
  ...
  return answerWithClaude(
    [
      ...
      "Answer only about using the product, academic planning, school workflows, subscriptions, AI Education Premium, and support.",
