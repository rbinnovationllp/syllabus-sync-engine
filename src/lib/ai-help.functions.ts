...
function localAnswer(message: string, page?: string | null) {
  ...
  if (q.includes("storage") || q.includes("upload limit") || q.includes("archive") || q.includes("fair usage")) {
    return "School Storage includes a Super Admin dashboard for allocated, used, and available storage, largest files, category usage, file-type breakdown, user-wise usage, and alerts at 80%, 90%, and 100%. Uploads are paused when the quota is full until files are removed, old academic sessions are archived, or additional storage is purchased. Additional storage prices are: 25 GB - Rs. 250/month, 50 GB - Rs. 500/month, 100 GB - Rs. 900/month, 250 GB - Rs. 2,000/month, and 500 GB - Rs. 3,500/month. For 1 TB or more, custom enterprise pricing is available through support@syllabus-synk.in.";
  }
