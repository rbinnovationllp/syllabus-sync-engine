...
export function friendlyOrgMemberError(rawMessage: string | null | undefined): string {
  ...
  if (
    ...
    return "We couldn't add you to your school workspace. This usually means your invitation has already been used, was sent to a different email, or your account isn't authorized. Please sign in with the invited email or contact admin@syllabus-synk.in.";
  }
  ...
  if (msg.includes("violates row-level security")) {
    return "You don't have permission to perform this action on this workspace. Please contact your school admin or admin@syllabus-synk.in.";
  }
