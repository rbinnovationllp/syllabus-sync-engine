...
- Repositioned public homepage and Ask Synk AI school-benefit messaging around the project's primary USP: accessible, software-first, age-appropriate AI education from Classes 1-12. Academic planning and syllabus-completion monitoring are positioned as the connected execution layer that helps schools introduce AI learning without losing visibility or control over regular academics. The public copy expressly avoids claiming mandatory or proprietary robotics-lab infrastructure.
- Added a public school-facing "The school advantage" section and Ask Synk AI starter/answer path that explain only current, defensible benefits: capacity-aware planning, early leadership visibility, teacher-facing syllabus-aware support, and the optional AI Education Premium pathway. This is a presentation upgrade only; it does not claim proprietary third-party content, robotics hardware, or unimplemented individual learner analytics.
